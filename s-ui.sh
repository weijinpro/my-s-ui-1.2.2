...
custom_version() {
    ...
    download_link="https://raw.githubusercontent.com/weijinpro/s-ui/master/install.sh"
...
update_shell() {
    wget -O /usr/bin/s-ui -N --no-check-certificate https://github.com/weijinpro/s-ui/raw/main/s-ui.sh
    if [[ $? != 0 ]]; then
        echo ""

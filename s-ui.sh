...
custom_version() {
    ...
    download_link="https://raw.githubusercontent.com/weijinpro/my-s-ui-1.2.2/master/install.sh"
...
update_shell() {
    wget -O /usr/bin/s-ui -N --no-check-certificate https://github.com/weijinpro/my-s-ui-1.2.2/raw/main/s-ui.sh
    if [[ $? != 0 ]]; then
        echo ""
